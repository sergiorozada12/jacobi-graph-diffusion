...
def prepare_search_space(cfg, space: SearchSpace):
    ...
    time_schedules = space.time_schedule or [cfg.sampler.time_schedule]
    time_schedule_powers = space.time_schedule_power or [cfg.sampler.time_schedule_power]
...
def configure_trial(cfg, params: Dict[str, Any]):
    ...
    cfg.sampler.time_schedule = params["time_schedule"]
    cfg.sampler.time_schedule_power = params["time_schedule_power"]
